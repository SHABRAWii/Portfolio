    ...
    var K = T(),
        ...
        ie = s((function e() {
            ...
            value: function() {
                ...
                const homePageUrl = currentUrl.split('/Project')[0];
                // window.history.pushState(null, null, homePageUrl); // Update URL to  Home page
                // window.history.pushState(null, null, e.href); // Update URL to current page
            }
        }, {
            key: "openAt",
            value: function() {
            ...
            const homePageUrl = currentUrl.split('/Project')[0];
            window.history.pushState(null, null, homePageUrl); // Update URL to  Home page
            window.history.pushState(null, null, e.elements[t].href); // Update URL to current page
            ...
            value: function() {
                ...
                // Set URL to the home page
                const currentUrl = window.location.href;
                const newUrl = currentUrl.split('/Project')[0]; // This removes the query string
